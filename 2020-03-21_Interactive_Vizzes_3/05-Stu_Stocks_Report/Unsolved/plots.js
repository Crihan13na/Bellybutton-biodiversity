...
function getMonthlyData() {
  ...
  d3.json(queryUrl).then(function(data) {
    ...
    var dates = unpack(data.datasets.data, 0);
    var openPrices = unpack(data.datasets.data, 1);
    var highPrices = unpack(data.datasets.data, 2);
    var lowPrices = unpack(data.datasets.data, 3);
    var closingPrices = unpack(data.datasets.data, 4);
    var volume = unpack(data.datasets.data, 5);
